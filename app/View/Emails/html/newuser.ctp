                        ...
                        <tbody><tr>
                            <td style="font-size:12px;line-height:1.5em;color:#444;padding-bottom:20px;border-bottom:1px solid #ccc;margin-bottom:20px" colspan="3"><h1 style="font-size:22px;font-weight:normal;color:#333;font-family:Georgia;line-height:150%;text-align:left;margin:10px 0px" colspan="2">
								<h1>Congrats!</h1>
									...
									<ol>
										<li>
											<a target="_blank" style="color:#800000;text-decoration:underline;font-weight:normal" href="http://viraliti.com/users/login/">Login Here</a></li>
										<li>Your credentials are :-<br>
											<b>Username</b> - <?php echo $data['userdata']['username'];?><br/>
											<b>Password</b> - <?php echo $data['userdata']['actualpass'];?><br/><br/>
											Please don't share your password with anyone. You can change this temporary password after logging in.
										</li>
										<li>
									...
									We have a multi levell referral policy. So you earn a percentage of the earning of every publisher that you refer to Viraliti. You earn a portion of earning of even their referrals. &nbsp;Spread your referral url - <b><?php echo $data['Presignup']['referral_url'];?></b><br>
									<br>
									<a target="_blank" style="color:#800000;text-decoration:underline;font-weight:normal" href="http://viraliti.com/users/login/">Login Now!</a><br>
