...
<h2><?php  echo __('Budget'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($budget['Budget']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Item Limit'); ?></dt>
		<dd>
			<?php echo h($budget['Budget']['item_limit']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Tag Line'); ?></dt>
		<dd>
			<?php echo h($budget['Budget']['tag_line']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Description'); ?></dt>
		<dd>
			<?php echo h($budget['Budget']['description']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Icons'); ?></dt>
		<dd>
			<?php echo h($budget['Budget']['icons']); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($budget['Profile'] as $profile): ?>
		<tr>
