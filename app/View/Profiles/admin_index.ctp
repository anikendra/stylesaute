<div class="profiles index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('body_shape'); ?></th>
			<th><?php echo $this->Paginator->sort('shirt_size'); ?></th>
			<th><?php echo $this->Paginator->sort('waist_size'); ?></th>
			<th><?php echo $this->Paginator->sort('inseam'); ?></th>
			<th><?php echo $this->Paginator->sort('fit'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($profile['Profile']['height']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['weight']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['body_shape']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['shirt_size']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['waist_size']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['inseam']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['fit']); ?>&nbsp;</td>
		<td>
